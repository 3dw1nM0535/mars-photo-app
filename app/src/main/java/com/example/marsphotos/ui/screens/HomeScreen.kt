...
fun HomeScreen(
    ...
    when(marsUiState) {
        ...
        is MarsUiState.Success -> PhotoGrid(photos = marsUiState.photos, modifier = modifier)
        else -> {}
    }
}
...
@Composable
fun PhotoGrid(photos: List<MarsPhoto>, modifier: Modifier = Modifier) {
    LazyVerticalGrid(
